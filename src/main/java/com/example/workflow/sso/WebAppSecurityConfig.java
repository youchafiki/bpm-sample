package com.example.workflow.sso;
...
public class WebAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public FilterRegistrationBean containerBasedAuthenticationFilter(){
        ...
        filterRegistration.setInitParameters(Collections.singletonMap("authentication-provider", "com.example" +
				        ".workflow" +
				        ".sso.KeycloakAuthenticationProvider"));
